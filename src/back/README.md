...
3.  **Configure as Variáveis de Ambiente**:
    ...
    -   Abra o arquivo `.env` e preencha as variáveis com suas informações:
        ```env
        # String de conexão com o cluster oficial (studiescluster)
        MONGO_URI=mongodb+srv://AdminDB:AdminDB@studiescluster.hcpbk9e.mongodb.net/co2ntazero?retryWrites=true&w=majority
