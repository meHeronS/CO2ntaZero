...
- Deve ser assinada por alunos(as), professores(as) e parceiro externo.
- Recomenda-se o uso do Gov.br para assinatura.

**Arquivo modelo:**
- `ata-acordo-com-cliente-externo.docx`
...
Por meio da procuração, o parceiro concede poderes à PUC Minas para realizar o registro no INPI, incluindo-o como cotitular.

**Orientações:**

- Deve ser preenchida pelo parceiro externo.
- Preferencialmente, deve ser utilizada a informação do CNPJ, e não do CPF.
- Recomenda-se assinatura pelo Gov.br.

**Arquivo modelo:**
- `procuracao-nit-pucminas.docx`
...
Nesse caso, não é necessário apresentar a procuração do NIT. Porém, o termo de renúncia é obrigatório para formalizar essa decisão.
...
**Arquivo modelo:**
- `termo-renuncia-direitos-cotitularidade.docx`
