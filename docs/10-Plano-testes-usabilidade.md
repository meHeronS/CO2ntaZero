...
|---------------|----------------------|
| 1             | Você é um Gestor de Sustentabilidade e precisa cadastrar a fatura de energia elétrica do mês. Localize a funcionalidade de "Transações", cadastre um consumo de 500 kWh e verifique se o valor foi salvo. |
